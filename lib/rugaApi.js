...
const stalktt = async (url) => new Promise((resolve, reject) => {
    axios.get(`http://zekais-api.herokuapp.com/tiktokstalk?query=${url}`)
        .then((res) => {
...
const ttpict = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://zekais-api.herokuapp.com/tiktokstalk?query=${url}`)
        .then((res) => {
...
const cekjodoh = async (nama, pasangan) => new Promise((resolve, reject) => {
    axios.get(`http://zekais-api.herokuapp.com/cekjodoh?nama=${nama}&pasangan=${pasangan}`)
        .then((res) => {
